...
/***********************************************************************************************
************************************************************************************************
MACRO FOR ØVRIGE AVLEDEDE VARIABLE

Innhold:
3.1 Retting av ugyldig alder
3.2 Aldersgrupper
3.3 Omkoding av KJONN til ErMann. Her hentes også kjønn for endel ugyldige fra variabelen kjonn_29082016.
3.4	ICD10KAP
3.5 ICD10KATBLOKK
3.6 HDIAG3TEGN
3.7 FAG_SKDE fra variablene FAG (2011-2014) og FAGLOGG (2015)
************************************************************************************************
***********************************************************************************************/

%Macro Avledede (Utdatasett=, Inndatasett=);
Data &Utdatasett;
Set &Inndatasett;
...
/*
**************************************************
3.2 Definerer Alder, ald_gr og Ald_gr5	
**************************************************
*/
...
/*else if 15 <= Alder <= 49 then Ald_gr5=2;*/
/*else if 50 <= Alder <= 64 then Ald_gr5=3;*/
/*else if 65 <= Alder <= 79 then Ald_gr5=4;*/
/*else if Alder > 79 then Ald_gr5=5;*/

/*Definerer variabel for aldersgrupper tilsvarende Ald_gr definert i Fantomet*/
/*if Alder=0 then ald_gr=1;*/
/*else if Alder=1 then ald_gr=2;*/
/*else if Alder=2 then ald_gr=3;*/
/*else if Alder=3 then ald_gr=4;*/
/*else if Alder=4 then ald_gr=5;*/
/*else if Alder=5 then ald_gr=6;*/
/*else if 6 <= Alder <= 9 then ald_gr=7;*/
/*else if 10 <= Alder <= 14 then ald_gr=8;*/
/*else if 15 <= Alder <= 19 then ald_gr=9;*/
/*else if 20 <= Alder <= 24 then ald_gr=10;*/
/*else if 25 <= Alder <= 29 then ald_gr=11;*/
/*else if 30 <= Alder <= 34 then ald_gr=12;*/
/*else if 35 <= Alder <= 39 then ald_gr=13;*/
/*else if 40 <= Alder <= 44 then ald_gr=14;*/
/*else if 45 <= Alder <= 49 then ald_gr=15;*/
/*else if 50 <= Alder <= 54 then ald_gr=16;*/
/*else if 55 <= Alder <= 59 then ald_gr=17;*/
/*else if 60 <= Alder <= 64 then ald_gr=18;*/
/*else if 65 <= Alder <= 69 then ald_gr=19;*/
/*else if 70 <= Alder <= 74 then ald_gr=20;*/
/*else if 75 <= Alder <= 79 then ald_gr=21;*/
/*else if 80 <= Alder <= 84 then ald_gr=22;*/
/*else if 85 <= Alder <= 89 then ald_gr=23;*/
/*else if Alder > 89 then ald_gr=24;*/

/*
**************************************************
3.3 Omkoding av KJONN til ErMann 	
**************************************************
*/

if kjonn = 1 then ErMann = 1;
else if kjonn = 2 then ErMann = 0; 
else if KJONN not in (1,2) then ErMann=.;
